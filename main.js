...
let projects = [
  {
    ...
    url: 'https://woodencork.com/',
  },
  {
    image: 'textures/2.PNG',
    url: 'https://swisshorology.co.uk/',
  },
  {
    image: 'textures/3.PNG',
    url: 'https://zaloupa.com/',
  },
  {
    image: 'textures/4.PNG',
    url: 'https://www.prochutes.com/',
  },
  {
    image: 'textures/5.PNG',
    url: 'https://carbonbetter.com/',
  },
  {
    image: 'textures/6.PNG',
    url: 'https://www.tncidercompany.com/',
  },
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Jackson Mori', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Shopify/Wordpress/Webflow Developer',
      {
        font: font,
        size: 0.018,
        height: 0,
